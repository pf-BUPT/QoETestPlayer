...
public class VideoActivity extends AppCompatActivity implements MediaPlayer.OnInfoListener, MediaPlayer.OnBufferingUpdateListener {
    ...
    long stopTimeAvg = 0;
    double mosOverall = 0;
    List<Long> stopTimeList = new ArrayList<Long>();
    ...
    private MyRatingBar ratingBar_back = null;
...
//        });
    ...
    class MyReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            paramsToPost.setMosOoverall(mosOverall);
            paramsToPost.setStopTimeAvg(stopTimeAvg);
            paramsToPost.setStopNum(stopNum);
            //dopost
            Gson gson = new Gson();
